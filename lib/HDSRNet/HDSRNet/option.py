import argparse
import lib.HDSRNet.HDSRNet.template as template

parser = argparse.ArgumentParser(description='EDSR and MDSR')
parser.add_argument('--f',
                    help='kernel json file', default=None)
...
parser.add_argument('--pre_train', type=str, default='models/HDSRNet/HDSRNet_x4.pt',
